...
# Read the CSV files
emotion_stats = pd.read_csv('csv/emotion_statistics.csv')
emotion_count = pd.read_csv('csv/emotion_count.csv')
...
# Save the bar chart
plt.savefig('charts/emotion_count.png')
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('charts/emotion_values.png')
