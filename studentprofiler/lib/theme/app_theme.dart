...
class AppThemeData {
  // Colors: Main Colors
  static const Color primaryColor = Color.fromRGBO(56, 113, 193, 1.0);
  static const Color secondaryColor = Color.fromRGBO(0, 173, 239, 1.0);

  // Colors: Text
  static const textPrimary = Color.fromRGBO(18, 18, 18, 1.0);
  ...
  static const iconSecondary = textPrimary;
  ...
  // Colors: Scaffold Light
  static const scaffoldLight = Color.fromRGBO(250, 250, 250, 1.0);
  static const appBarLight = Color.fromRGBO(250, 250, 250, 1.0);

  // Colors: Opacity
  static const opacityPrimary =
      Color.fromRGBO(56, 113, 193, 0.5019607843137255);
